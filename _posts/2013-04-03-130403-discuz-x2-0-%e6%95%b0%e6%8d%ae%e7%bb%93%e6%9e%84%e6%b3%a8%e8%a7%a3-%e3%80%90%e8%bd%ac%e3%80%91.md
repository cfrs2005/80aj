...
optionid  mediumint(8) unsigned NOT NULL default '0' COMMENT '资料统计项 id',
uid mediumint(8) unsigned NOT NULL default '0' COMMENT '用户id',
PRIMARY KEY  (optionid, uid)
) ENGINE=MyISAM COMMENT='搜索统计项用户ID缓存表';

CREATE TABLE pre_common_member_stat_search (
optionid  mediumint(8) unsigned NOT NULL auto_increment COMMENT '搜索统计项 id',
title varchar(255) NOT NULL default '' COMMENT '搜索统计项名称' ,
`condition` text NOT NULL COMMENT '检索条件' ,
hash varchar(255) NOT NULL default '' COMMENT '检索条件 hash',
users mediumint(8) unsigned NOT NULL default '0' COMMENT '对应用户数',
updatetime int(10) unsigned NOT NULL default '0' COMMENT '更新时间',
PRIMARY KEY  (optionid),
KEY hash (hash)
) ENGINE=MyISAM COMMENT='用户资料由搜索保存的统计项' AUTO_INCREMENT=1;

CREATE TABLE pre_common_member_stat_searchcache (
optionid  mediumint(8) unsigned NOT NULL default '0' COMMENT '搜索统计项 id',
uid mediumint(8) unsigned NOT NULL default '0' COMMENT '用户id',
PRIMARY KEY  (optionid, uid)
) ENGINE=MyISAM COMMENT='搜索统计项用户ID缓存表';
...
`uid` mediumint(8) unsigned NOT NULL default '0' COMMENT 'pk',
`uin` char(40) NOT NULL COMMENT 'connect uin',
`type` tinyint(1) NOT NULL default '0' COMMENT '1=绑定/2=解绑',
`dateline` int(10) unsigned NOT NULL default '0' COMMENT '创建时间',
PRIMARY KEY  (`mblid`),
KEY `uid` (`uid`),
KEY `uin` (`uin`),
KEY `dateline` (`dateline`)
) ENGINE=MyISAM COMMENT='Connect 用户绑定/解绑记录表';

CREATE TABLE pre_connect_feedlog (
`flid` mediumint(8) unsigned NOT NULL auto_increment COMMENT 'pk',
`tid` mediumint(8) unsigned NOT NULL default '0' COMMENT '主题id',
`uid` mediumint(8) unsigned NOT NULL default '0' COMMENT '用户id',
`publishtimes` MEDIUMINT( 8 ) UNSIGNED NOT NULL DEFAULT '0' COMMENT '调用次数',
`lastpublished` int(10) unsigned NOT NULL default '0' COMMENT '时间推送feed时间',
`dateline` int(10) unsigned NOT NULL default '0' COMMENT '创建时间',
`status` tinyint(1) NOT NULL default '1' COMMENT '1=未推送；2=已推送；3=推送成功；4=已删除',
PRIMARY KEY  (`flid`),
UNIQUE KEY `tid` (`tid`)
) ENGINE=MyISAM COMMENT='Connect feed日志表';

CREATE TABLE pre_connect_tlog (
`tlid` mediumint(8) unsigned NOT NULL auto_increment COMMENT 'pk',
`tid` mediumint(8) unsigned NOT NULL default '0' COMMENT '主题id',
`uid` mediumint(8) unsigned NOT NULL default '0' COMMENT '用户id',
`publishtimes` MEDIUMINT( 8 ) UNSIGNED NOT NULL DEFAULT '0' COMMENT '调用次数',
`lastpublished` int(10) unsigned NOT NULL default '0' COMMENT '时间推送feed时间',
...
maxpostsperhour tinyint(3) unsigned NOT NULL default '0' COMMENT '每小时发帖数限制',
...
tagname varchar(20) NOT NULL default '' COMMENT '标签名',
...
tagid smallint(6) NOT NULL default '0' COMMENT '标签id',
tagname varchar(20) NOT NULL default '' COMMENT '标签名',
itemid mediumint(8) NOT NULL default '0' COMMENT 'itemid',
idtype varchar(255) NOT NULL default '' COMMENT '内容类型',
...
PRIMARY KEY  (`key`)
) ENGINE=MyISAM COMMENT='扩展中心资源提供商';
...
allowfeed tinyint(1) NOT NULL default '0' COMMENT '允许推送动态',
...
level smallint(6) unsigned NOT NULL default '0' COMMENT '群组等级',
...
id mediumint(8) unsigned NOT NULL default '0' COMMENT '来源ID',
...
cid mediumint(8) unsigned NOT NULL auto_increment COMMENT '内容ID',
...
primaltplname varchar(255) NOT NULL default '0' COMMENT '原模板地址',
...
`options` text NOT NULL default '' COMMENT '选项 \t 分隔',
dateline int(10) unsigned NOT NULL default '0' COMMENT '发表时间',
KEY tid (tid),
KEY uid (uid, dateline)
...
replycredit smallint(6) NOT NULL default '0' COMMENT '回帖获得积分记录',
PRIMARY KEY  (pid),
KEY fid (fid),
...
KEY `pid` (`pid`)
) ENGINE=MyISAM COMMENT='抢楼帖楼层记录表';
...
`type` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT '记录类型   `value` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '记录值',
...
starttimefrom int(10) unsigned NOT NULL default '0' COMMENT '开始时间',
starttimeto int(10) unsigned NOT NULL default '0' COMMENT '结束时间',
rewardfloor varchar(255) NOT NULL default '' COMMENT '奖励楼层',
PRIMARY KEY  (tid)
) ENGINE=MyISAM COMMENT='抢楼设置表';

CREATE TABLE pre_forum_threadtype (
typeid smallint(6) unsigned NOT NULL auto_increment COMMENT '主题分类id',
